...
(function (root) {
    ...
    AudioPlayer.prototype = {
        ...
        // 跳转播放
        jumpToPlay: function jumpToPlay(time) {
...
(function (root) {
    ...
    var ControlManager = function ControlManager(length) {
        this.length = length;
        this.index = 0;
    };
    ...
    ControlManager.prototype = {
        ...
        getIndex: function getIndex(val) {
...
(function (root) {
    ...
    var $playList = $('<div class="play-list">' + '<div class="list-head">播放列表</div>' + '<ul class="play-list-container"></ul>' + '<div class="close-btn">关闭</div>' + '</div>'),
        tempIndex,
        $body = $(document.body);
...
(function (root) {
    ...
    function renderInfo(info) {
        var html = '<h1 class="song-name">' + info.song + '</h1>' + '<h3 class="singer-name">' + info.singer + '</h3>' + '<h3 class="album-name">' + info.album + '</h3>';
